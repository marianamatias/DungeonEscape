...
SOURCES            = main.c myLib.c game.c spritesheet.c collisionmap.c collisionmap2.c menu.c pause.c win.c lose.c instructions.c level1.c level1Screen.c level2.c level2Screen.c menuSong.c gameSong.c collideSound.c sound.c brickWall.c accept.c magic.c loseSound.c winSound.c
CCPATH             = /usr/bin
